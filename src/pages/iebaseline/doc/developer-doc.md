...
| Start Module / Continue Module / View Module / Result | Label is derived from assignment status | Routes to `/iebaseline/module/{module_id}` | No direct call; target page calls `GET /home` |
